...
function local_unoproj (lpath) {
	if (local_name !== '') return resolve(local_name);
...
function save_unoproj (fn, obj) {
	debug("save_unoproj");
	fs.writeFileSync(fn, JSON.stringify(obj, null, 4) + "\n", 'utf8');
}

function save_to_unoproj (fn, addobj) {
...
module.exports = {
	...
	read_unoproj: read_unoproj,
	save_to_unoproj: save_to_unoproj,
	local_unoproj: local_unoproj
};